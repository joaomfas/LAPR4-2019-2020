...
#define SHM_NAME "/shm_maquina1"
#define SEM_NAME "/sem_maquina1_"
...
#define CLIENT_SSL_CERT_FILE "./certificados/client2.pem"
#define CLIENT_SSL_KEY_FILE "./certificados/client2.key"
